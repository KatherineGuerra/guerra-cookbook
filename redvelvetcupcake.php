...
<!--this red velvet cupcake is one of my favorite recipes-->
<!--all of the body tag with ids will have the same background image-->
<body id="homescreen">
    <img src="unnamed.png" alt="" class="logo"/>
    <!--    theses navs tags will also appear on this page-->
    <nav>
...
<!--        this will allow the text to have bullet points-->
...
<!--allows it to have numbers on each number-->
<ol type="1">
